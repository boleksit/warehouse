...
namespace warehouse;
//immutable
public sealed class Box_old :IFormattable, IEquatable<Box_old>, IEnumerable<double>
{
    ...
    public Box_old(double a=-99, double b=-99, double c=-99, UnitOfMeasure unit = UnitOfMeasure.meter)
    {
        if (a == -99)
        {
            a = unit switch
    ...
    public bool Equals(Box_old? other)
    {
    ...
    public static Box_old operator +(Box_old p1, Box_old p2)
    {
        List<Box_old> pudelka = new List<Box_old>();
        pudelka.Add(new Box_old(p1._a+p2._a,p1._b+p2._b,p1._c+p2._c,UnitOfMeasure.milimeter));
        pudelka.Add(new Box_old(p1._a+p2._a,p1._b+p2._c,p1._c+p2._b,UnitOfMeasure.milimeter));
        pudelka.Add(new Box_old(p1._a+p2._b,p1._b+p2._c,p1._c+p2._a,UnitOfMeasure.milimeter));
        pudelka.Add(new Box_old(p1._a+p2._c,p1._b+p2._b,p1._c+p2._a,UnitOfMeasure.milimeter));
        pudelka.Add(new Box_old(p1._a+p2._b,p1._b+p2._a,p1._c+p2._c,UnitOfMeasure.milimeter));
        pudelka.Add(new Box_old(p1._a+p2._c,p1._b+p2._a,p1._c+p2._b,UnitOfMeasure.milimeter));

        Box_old? min=null;
        
        foreach (Box_old pud in pudelka)
        {
    ...
    {
        return obj is Box_old && Equals((Box_old)obj);
    }
    public override int GetHashCode() => (_a,_b,_c).GetHashCode();
    public static bool operator ==(Box_old p1, Box_old p2) => Equals(p1, p2);
    public static bool operator !=(Box_old p1, Box_old p2) => !(p1 == p2);

    public static explicit operator double[](Box_old p1) => new double[] {p1.A, p1.B, p1.C};
    
    public static implicit operator Box_old(ValueTuple<int, int, int> tuple)=>
         new Box_old(tuple.Item1,tuple.Item2,tuple.Item3, UnitOfMeasure.milimeter);
    ...
    public static Box_old Parse(string val)
    {
        ...
        return dim.Count == 3
            ? new Box_old(dim[0], dim[1], dim[2], unit)
            : throw new FormatException("Incorrect input!");
    }
    public static int Comparison(Box_old p1, Box_old p2)
    {
